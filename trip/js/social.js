...
const opencreatingPost = () => {
    creatingPost.style.display = 'grid';
}

const closecreatingPost = (e) => {
    if (e.target.classList.contains('creating-post')) {
        creatingPost.style.display = 'none'
    }
}

creatingPost.addEventListener('click', creatingPost);
create.addEventListener('click', opencreatingPost);
